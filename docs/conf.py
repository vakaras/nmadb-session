...
latex_documents = [
  (
      'index', 'main.tex',
      u'\\nmadb-session Documentation', u'\\Vytautas Astrauskas', 'manual'
      ),
  ]
...
man_pages = [
    (
        'index', 'main',
        u'nmadb-session Documentation', [u'Vytautas Astrauskas'], 1,
        ),
    ]
...
pdf_documents = [
    (
        'index', u'main',
        u'nmadb-session Documentation', u'Vytautas Astrauskas'
        ),
    ]
